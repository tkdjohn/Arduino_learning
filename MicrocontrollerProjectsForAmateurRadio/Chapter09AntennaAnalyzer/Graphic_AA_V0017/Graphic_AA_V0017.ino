...
//                            STM32F103
//
//    NOTE: The graphics library calls a second library "behind your back". Put this on path; https://github.com/adafruit/Adafruit_BusIO
//
...
//========================================================= Global data ===================================
char *menuOptions[]     = {" Full ", " Bands ", " Freq ", "Zero","Cal"}; // Menu text
